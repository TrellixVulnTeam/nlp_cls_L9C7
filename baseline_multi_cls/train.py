...
if __name__ == "__main__":
    ...
    train_loader = init_dataloader(data_type="train", batch_size=args.train_batch_size, dataset_type=args.dataset_type)
    dev_loader   = init_dataloader(data_type="dev",   batch_size=args.dev_batch_size,   dataset_type=args.dataset_type)
    ...
    model = Bert_CLS.from_pretrained(args.bert_path, num_labels=15).cuda()
